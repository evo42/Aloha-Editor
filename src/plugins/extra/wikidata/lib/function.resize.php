...
function resize($imagePath,$opts=null){
	...
	# start configuration
	$baseFolder = dirname($_SERVER['SCRIPT_FILENAME']);
	$cacheFolder = $baseFolder.'/../img/'; # path to your cache folder, must be writeable by web server
	...
	//if(file_get_contents($imagePath) == false):
